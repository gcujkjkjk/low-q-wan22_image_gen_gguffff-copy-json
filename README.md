# low-q-wan22_image_gen_gguffff-copy-json
...
docker build -t low-q-wan22_image_gen_gguffff-copy-json .

# Run the container
docker run -p 8188:8188 low-q-wan22_image_gen_gguffff-copy-json
```
